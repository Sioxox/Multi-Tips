...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Éditeur Multi Tips</title>
	...
	<body>
		<?php
			...
			$end_link = basename($link);

			$generated_link = rtrim(str_replace($end_link , "", $link), "/");
		?>
		<input id="link" type="text" size="160" value="<?php echo $generated_link ?>" readonly><input type="button" value="Copier" onClick="copy()"><br>
		...
		<a href="https://github.com/regisandre/Multi-Tips"><span id="github" style="position: absolute; bottom: 10px; left: 10px;">GitHub</span></a>
		<a href="#"><span id="sioxox-tips" style="position: absolute; bottom: 10px; left: 50%;">Faire un don</span></a>
		<span id="copyright" style="position: absolute; bottom: 10px; right: 10px;">Régis ANDRÉ © 2020</span>
